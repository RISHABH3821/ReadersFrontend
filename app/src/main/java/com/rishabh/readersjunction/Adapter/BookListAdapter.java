...
public class BookListAdapter extends RecyclerView.Adapter<BookListAdapter.ViewHolder> {
  ...
  public BookListAdapter(ArrayList<BookDataModel> data, Context context) {
    this.dataSet = data;
  ...
  @NonNull
  @Override
  public BookListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent,
      int viewType) {
  ...
  @Override
  public void onBindViewHolder(@NonNull final BookListAdapter.ViewHolder holder,
